...
######################################
#        PROJECT: TERMUX BANNER      #
#        Author: mamba-9mm           #
#     Facebook: @mambamentality9mm   #
...
cd T-Banner/properties
cp ASCII-Shadow.flf ${PREFIX}/share/figlet

# change dir to home/T-Banner
cd $HOME
cd T-Banner
...
echo -e "\e[31m[\e[32m14\e[31m]\e[33m Best-of-T-Banner\e[m "
...
echo
echo "[*] Applying T-Banner " |lolcat -t
sleep 2
echo
